...
export const treatments: Treatment[] = [
  ...
  },
  {
    ...
    metaDescription:
      "Safe, comfortable wisdom tooth extraction in Wanowrie (Wanwadi), Pune. Impacted and painful wisdom teeth removed under local anaesthesia. Same-day emergency slots — 093731 43403.",
  ...
  },
  {
    ...
    highlights: [
      ...
      },
      {
        ...
        desc: "Two to four implants can lock a denture firmly in place — no slipping while eating or speaking. The most life-changing upgrade for loose lower dentures.",
      },
      {
  ...
  },
  {
    ...
    metaDescription:
      "Dental emergency in Wanowrie or Wanwadi, Pune? Same-day appointments for severe toothache, swelling, broken teeth and knocked-out teeth. Open all 7 days — 093731 43403.",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Take an over-the-counter painkiller as per its label, keep your head elevated, avoid very hot or cold food, and never place aspirin against the gum — it burns the tissue. Message us on WhatsApp; we’ll see you at the earliest slot.",
      },
      {
